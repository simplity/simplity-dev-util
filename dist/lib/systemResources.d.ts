export declare const systemResources: {
    records: {
        _columnSelection: import("simplity-types").SimpleRecord;
        _filters: import("simplity-types").SimpleRecord;
        _reportSettings: import("simplity-types").SimpleRecord;
        _reportSettingsHeader: import("simplity-types").SimpleRecord;
        _sorts: import("simplity-types").SimpleRecord;
    };
    messages: {
    ...
    valueLists: import("simplity-types").StringMap<import("simplity-types").ValueList>;
    valueSchemas: import("simplity-types").StringMap<import("simplity-types").ValueSchema>;
};
