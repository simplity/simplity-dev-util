...
function templateToPages(template, form, pages) {
    ...
    if (template.type === 'master') {
        ...
        if (pageExists(pageName, pages, templateName)) {
            ...
            [pages[pageName], nbrErrors] = new Gen(toListPage(template), form).generate();
        }
        ...
        if (pageExists(pageName, pages, templateName)) {
            ...
            [pages[pageName], nbrErrors] = new Gen(toViewPage(template), form).generate();
        }
        ...
        if (pageExists(pageName, pages, templateName)) {
            ...
            [pages[pageName], nbrErrors] = new Gen(toSavePage(template), form).generate();
        }
        return nbrErrors;
    }
    /**
