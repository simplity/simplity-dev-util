...
function alterChildren(parent, alts, nbrTasks) {
    ...
    for (const child of parent.children) {
        ...
        if (toDelete) {
            if (anUpdate) {
                console.warn(`Warning: Element ${parentName} specifies that its child element ${childName} be altered, but it also specifies that it should be deleted. deletion command ignored.`);
                nbrTasks--;
            }
            else {
                nbrTasks--;
...
//# sourceMappingURL=alterPage.js.map