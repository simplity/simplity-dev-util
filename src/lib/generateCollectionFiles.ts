...
type CollectionParams = {
  ...
  ext: string;
  type: string;
  folderName?: string; // defaults to name
};

const collections: CollectionParams[] = [
  {
    name: 'alters',
    ext: 'alter',
    type: 'PageAlteration',
...
function writeIt(folder: string, fileName: string, text: string) {
...
function toSimpleName(name: string): string {
